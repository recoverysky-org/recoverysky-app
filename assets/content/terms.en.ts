 ...
 */
export const termsText = `Terms and Conditions
Last updated: March 24, 2026
...
- Application means the software program provided by the Company downloaded by You on any electronic device, named RecoverySky.
...
- Company (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to RecoverySky Org, a Not For Profit organization formed in Delaware, United States.
...
We reserve the right, at Our sole discretion, to modify or replace these Terms at any time. Your continued use of the Service after changes take effect constitutes acceptance of the revised terms. If You do not agree to the new terms, in whole or in part, please stop using the Service.

Contact Us
If you have any questions about these Terms and Conditions, You can contact us by email: admin@recoverysky.org`
