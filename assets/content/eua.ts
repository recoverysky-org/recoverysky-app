 ...
 */
export const euaText = `EULA
Last updated: Dec 31, 2025 1:22 AM

Please read this End User License Agreement ("EULA") carefully before installing and using the Recovery Sky App software ("the Software") operated by RecoverySky Org, a(n) Not For Profit formed in Delaware, United States as this EULA contains important information regarding the limitations of our liability. Your access to and use of the Software is conditional upon your acceptance of and compliance with this EULA. This EULA applies to everyone, including viewers, users, and others who wish to access or use the Software.
...
License rights
RecoverySky Org grants you the non-exclusive, revocable, limited license to install and use the Software subject to the terms contained in this End User License Agreement. The license that is granted to you is solely for personal, non-commercial use only. You are hereby prohibited from any reproduction of the Software. You may install any number of copies of this Software.

WARRANTY
NO WARRANTY, EXPRESS OR IMPLIED (INCLUDING ANY IMPLIED WARRANTY OF MERCHANTABILITY OR FITNESS FOR A PARTICULAR PURPOSE) SHALL APPLY TO THE SOFTWARE; WHETHER ARISING BY LAW, COURSE OF DEALING, COURSE OF PERFORMANCE, USAGE OF TRADE OR OTHERWISE. RECOVERYSKY ORG MAKES NO WARRANTY REGARDING FREEDOM FROM BUGS OR UNINTERRUPTED USE.

LIMITATION OF LIABILITY
IN NO EVENT SHALL RECOVERYSKY ORG BE LIABLE TO YOU FOR CONSEQUENTIAL, INCIDENTAL, SPECIAL, INDIRECT, EXEMPLARY, PUNITIVE OR ENHANCED DAMAGES ARISING OUT OF OR RELATING TO THE SOFTWARE OR ANY BREACH OF THIS AGREEMENT (INCLUDING, WITHOUT LIMITATION, LOST PROFITS, LOST REIMBURSEMENTS, LOST DATA, OR LOST SAVINGS, DAMAGES THAT RESULT FROM THE USE OF OR INABILITY TO USE THE SOFTWARE, OR THAT RESULT FROM MISTAKES, OMISSIONS, INTERRUPTIONS, DELETION OF FILES, ERRORS, DELAYS IN OPERATION, OR TRANSMISSION OR ANY FAILURE OF PERFORMANCE, WHETHER OR NOT LIMITED TO ACTS OF GOD, COMMUNICATION FAILURE, THEFT, DESTRUCTION OR UNAUTHORIZED ACCESS TO CUSTOMER'S RECORDS, PROGRAMS OR SERVICES), IRRESPECTIVE IF WE WERE ADVISED OF THE POSSIBILITY OF THE OCCURRENCE OF SUCH DAMAGES, AND REGARDLESS OF THE LEGAL OR EQUITABLE THEORY (CONTRACT, TORT OR OTHERWISE) UPON WHICH THE CLAIM IS BASED.

MAXIMUM LIABILITY
THE AGGREGATE LIABILITY OF RECOVERYSKY ORG ARISING OUT OF OR RELATED TO THIS AGREEMENT OR THE SOFTWARE, WHETHER ARISING OUT OF OR RELATED TO BREACH OF CONTRACT, TORT (INCLUDING NEGLIGENCE) OR OTHERWISE, SHALL BE LIMITED TO THE AMOUNT OF FEES ACTUALLY RECEIVED BY US FROM YOU FOR THE SOFTWARE.

DISPUTE RESOLUTION
Any controversy or claim arising out of or relating to this End User License Agreement including but not limited to the interpretation or breach thereof shall be resolved in a court of competent jurisdiction in Greene County, Missouri, United States.
