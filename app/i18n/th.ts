...
const th: Translations = {
  ...
  externalZoomEducation: {
    title: "โปรดทราบ",
    body: "เมื่อเข้าร่วมการประชุมด้วย Zoom ภายนอก ต้องติดตั้งแอป Zoom ไว้\n\nตัวจับเวลาจะเริ่มทำงาน คุณต้องกลับมาที่แอป RecoverySky หลังจากสิ้นสุดการประชุม Zoom เพื่อหยุดตัวจับเวลาอย่างถูกต้องและรับเครดิตการเข้าร่วม",
