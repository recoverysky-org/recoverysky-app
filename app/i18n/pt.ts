...
const pt: Translations = {
  common: {
    ...
    updateMessage: "O RecoverySky vai atualizar rapidamente agora.",
    storeUpdateTitle: "Nova versão disponível",
    storeUpdateMessage: "Uma nova versão do RecoverySky está disponível. Atualize para obter os recursos e correções mais recentes.",
    storeUpdateButton: "Atualizar agora",
  ...
  errorScreen: {
    ...
    friendlySubtitle: "Pedimos desculpas — algo não funcionou como esperado. Por favor, reinicie o app. Se o problema persistir, entre em contato em support@recoverysky.org.",
    reset: "REINICIAR APP",
  ...
  homeScreen: {
    ...
    onboardingDescription:
      "Refaça a integração a qualquer momento para personalizar o app e saber mais sobre privacidade.",
  ...
  attendanceScreen: {
    ...
    exportReportDialog: "Exportar Relatório de Presença",
    exportReportError: "Não foi possível exportar o relatório. Tente novamente.",
  ...
  settingsScreen: {
    ...
    userIdNumPlaceholder: "(opcional) Seu número de relatório",
    ...
    errorReportSuccess: "Relatório Enviado com Sucesso",
    errorReportSuccessMessage: "Obrigado! Seu relatório foi enviado.",
    errorReportFailed: "Falha ao Enviar",
    errorReportFailedMessage: "Não foi possível enviar o relatório de erro. Tente novamente mais tarde.",
    checkForUpdates: "Verificar Atualizações",
    checkingForUpdates: "Verificando...",
    noUpdatesAvailable: "Você Está Atualizado",
  ...
  topicPrompt: {
    ...
    hostPlaceholder: "Anfitrião da reunião",
    save: "Salvar",
    skip: "Pular",
  },
  externalZoomTimer: {
  ...
  attendanceEdit: {
    ...
    save: "Salvar",
    saved: "Duração atualizada",
    saveError: "Não foi possível atualizar a duração. Tente novamente.",
  },
  devScreen: {
  ...
  moneySaved: {
    ...
    Sat: "Sábado",
    Sun: "Domingo",
    tobacco: "Tabaco diário",
    save: "Salvar",
    totalDays: "em {{count}} dias de recuperação",
  },
  recoveryChart: {
    selectRange: "Selecionar Período",
    legend: "Minutos de Reunião por Dia",
    days7: "7 Dias",
    days30: "30 Dias",
    days60: "60 Dias",
    days90: "90 Dias",
    allTime: "Todo o Tempo",
    noData: "Sem dados de presença ainda",
  },
  ninetyInNinety: {
    title: "Desafio 90 em 90",
    titleComplete: "90 em 90 Completo!",
    description: "Participe de 90 reuniões em 90 dias. Um pilar da recuperação inicial.",
    startChallenge: "Iniciar Desafio",
    meetingsCount: "{{count}} / 90",
    meetingsLabel: "Reuniões Participadas",
    totalTime: "Tempo Total: {{time}}",
    hoursAttended: "{{hours}} / 90 Horas Participadas",
    dayProgress: "Dia {{current}} de 90",
    daysRemaining_one: "{{count}} dia restante",
    daysRemaining_other: "{{count}} dias restantes",
    strictMode: "Modo Rigoroso",
    strictDescription: "Requer pelo menos uma reunião de 60 minutos todos os dias",
    strictCompliant: "{{compliant}} / {{total}} dias cumpridos",
    strictFailed: "Um dia foi perdido. Desative o modo rigoroso para continuar.",
    congratulations: "Parabéns!",
    challengeComplete: "Você completou o desafio 90 em 90!",
    getCertificate: "Obter Certificado",
    viewCertificate: "Ver Certificado",
    shareCertificate: "Compartilhar Certificado",
    certificateReady: "O certificado está pronto!",
    certificateError: "Não foi possível gerar o certificado",
    challengeExpired: "Desafio Encerrado",
    expiredMessage: "Você participou de {{count}} de 90 reuniões.",
    startNew: "Novo Desafio",
    resetTitle: "Reiniciar Desafio",
    resetMessage: "Isso apagará seu progresso atual. Tem certeza?",
  ...
  subscription: {
    restoreSuccess: "Compras restauradas!",
    restoreFailed: "Nenhuma compra encontrada",
    syncSuccess: "Bem-vindo de volta! Sua assinatura foi restaurada.",
  },
  accessibility: {
    doubleTapToView: "Toque duas vezes para ver detalhes",
    doubleTapToJoin: "Toque duas vezes para entrar na reunião",
    doubleTapToArchive: "Toque duas vezes para arquivar este registro",
    doubleTapToDelete: "Toque duas vezes para excluir este registro",
    doubleTapToSelect: "Toque duas vezes para selecionar para o relatório",
    doubleTapToToggleFavorite: "Toque duas vezes para alternar favorito",
    doubleTapToRate: "Toque duas vezes para definir a avaliação",
    doubleTapToExpand: "Toque duas vezes para expandir ou recolher",
    ...
    closeMeeting: "Fechar detalhes da reunião",
    selectForReport: "Selecionar para relatório",
    settings: "Ajustes",
    selectFellowship: "Selecionar irmandade, atual: {{value}}",
    selectDay: "Selecionar dia",
    selectLanguage: "Selecionar idioma",
    selectTime: "Selecionar horário",
    recordArchived: "Registro arquivado",
    recordDeleted: "Registro excluído",
    recordSelected: "Registro selecionado",
    recordDeselected: "Registro desmarcado",
