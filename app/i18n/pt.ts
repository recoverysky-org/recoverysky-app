...
const pt: Translations = {
  ...
  onboarding: {
    ...
    noTracking: "Sem analytics, sem rastreamento, sem Google",
    totalAnonymity: "Privacidade e anonimato completos",
    minimalNetwork: "O único tráfego de rede é pra listas de reuniões ao vivo",
