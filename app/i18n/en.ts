const en = {
  ...
  errorScreen: {
    ...
    friendlySubtitle:
      "We're sorry — something didn't work as expected. Please try restarting the app. If the problem continues, reach out to us at support@recoverysky.org.",
    reset: "RESTART APP",
  ...
  settingsScreen: {
    ...
    userIdNum: "ID Number",
    userIdNumPlaceholder: "(optional) Your reporting number",
  ...
  cleanTime: {
    ...
    year_zero: "{{count}} Years",
    year_one: "{{count}} Year",
    year_two: "{{count}} Years",
    year_few: "{{count}} Years",
    year_many: "{{count}} Years",
    year_other: "{{count}} Years",
    month_zero: "{{count}} Months",
    month_one: "{{count}} Month",
    month_two: "{{count}} Months",
  ...
  moneySaved: {
    ...
    Sat: "Saturday",
    Sun: "Sunday",
    tobacco: "Daily tobacco",
    save: "Save",
    totalDays: "over {{count}} days in recovery",
  },
  recoveryChart: {
  ...
  ninetyInNinety: {
    ...
    titleComplete: "90 in 90 Complete!",
    description: "Attend 90 meetings in 90 days. A cornerstone of early recovery.",
    startChallenge: "Start Challenge",
    meetingsCount: "{{count}} / 90",
    meetingsLabel: "Meetings Attended",
    totalTime: "Total Time: {{time}}",
    hoursAttended: "{{hours}} / 90 Hours Attended",
    dayProgress: "Day {{current}} of 90",
    daysRemaining_one: "{{count}} day remaining",
    daysRemaining_other: "{{count}} days remaining",
    strictMode: "Strict Mode",
    strictDescription: "Requires at least one 60-minute meeting every day",
    strictCompliant: "{{compliant}} / {{total}} days compliant",
    strictFailed: "A day was missed. Toggle strict mode off to continue.",
    congratulations: "Congratulations!",
    challengeComplete: "You completed the 90 in 90 challenge!",
    getCertificate: "Get Certificate",
    viewCertificate: "View Certificate",
    shareCertificate: "Share Certificate",
    certificateReady: "Certificate is ready!",
    certificateError: "Could not generate certificate",
    challengeExpired: "Challenge Ended",
    expiredMessage: "You attended {{count}} of 90 meetings.",
    startNew: "Start New Challenge",
    resetTitle: "Reset Challenge",
    resetMessage: "This will erase your current progress. Are you sure?",
    resetButton: "Reset",
  },
  maintenance: {
  ...
  accessibility: {
    ...
    doubleTapToArchive: "Double-tap to archive this record",
    doubleTapToDelete: "Double-tap to delete this record",
    doubleTapToSelect: "Double-tap to select for report",
    doubleTapToToggleFavorite: "Double-tap to toggle favorite",
    doubleTapToRate: "Double-tap to set rating",
    doubleTapToExpand: "Double-tap to expand or collapse",
    ...
    recordDeselected: "Record deselected",
