...
const ar: Translations = {
  ...
  externalZoomEducation: {
    title: "انتبه",
    body: "عند الانضمام إلى اجتماع باستخدام Zoom الخارجي، يجب أن يكون تطبيق Zoom مثبتًا.\n\nسيتم تشغيل مؤقت. يجب عليك العودة إلى تطبيق RecoverySky بعد إنهاء اجتماع Zoom لإيقاف المؤقت بشكل صحيح واستلام رصيد الحضور.",
    continue: "متابعة",
  },
  attendanceEdit: {
    title: "تعديل المدة",
