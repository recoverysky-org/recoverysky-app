...
const ar: Translations = {
  common: {
    ...
    storeUpdateTitle: "إصدار جديد متاح",
    storeUpdateMessage: "يتوفر إصدار جديد من RecoverySky. يرجى التحديث للحصول على أحدث الميزات والإصلاحات.",
    storeUpdateButton: "تحديث الآن",
  ...
  attendanceScreen: {
    ...
    exportReportDialog: "تصدير تقرير الحضور",
    exportReportError: "تعذّر تصدير التقرير. يُرجى المحاولة مرة أخرى.",
  ...
  settingsScreen: {
    ...
    userIdNumPlaceholder: "(اختياري) رقم التقارير الخاص بك",
    ...
    checkingForUpdates: "جارٍ البحث...",
    noUpdatesAvailable: "أنت محدّث",
  ...
  externalZoomTimer: {
    ...
    save: "حفظ",
    cancelTitle: "تجاهل المؤقت؟",
    cancelMessage: "ستُفقد {{minutes}} دقيقة من الحضور.",
    keepRunning: "الإبقاء على التشغيل",
    discard: "تجاهل",
    recoverTitle: "حضور غير محفوظ",
    recoverMessage: "لديك {{minutes}} دقيقة من حضور «{{name}}» لم تُحفظ. حفظها الآن؟",
    recoverSave: "حفظ",
  ...
  externalZoomEducation: {
    title: "انتبه",
    body: "عند الانضمام إلى اجتماع باستخدام Zoom الخارجي، يجب أن يكون تطبيق Zoom مثبتًا. سيتم تشغيل مؤقت. يجب عليك العودة إلى تطبيق RecoverySky بعد إنهاء اجتماع Zoom لإيقاف المؤقت بشكل صحيح واستلام رصيد الحضور.",
    continue: "متابعة",
  },
  attendanceEdit: {
    title: "تعديل المدة",
    ...
    save: "حفظ",
    saved: "تم تحديث المدة",
    saveError: "تعذّر تحديث المدة. يُرجى المحاولة مرة أخرى.",
  },
  devScreen: {
    title: "أدوات المطور",
  ...
  accessibility: {
    doubleTapToView: "انقر مرتين لعرض التفاصيل",
    doubleTapToJoin: "انقر مرتين للانضمام إلى الاجتماع",
    doubleTapToArchive: "انقر مرتين لأرشفة هذا السجل",
    doubleTapToDelete: "انقر مرتين لحذف هذا السجل",
    doubleTapToSelect: "انقر مرتين لتحديده للتقرير",
    doubleTapToToggleFavorite: "انقر مرتين لتبديل المفضلة",
    doubleTapToRate: "انقر مرتين لتعيين التقييم",
    doubleTapToExpand: "انقر مرتين للتوسيع أو الطي",
    ...
    closeMeeting: "إغلاق تفاصيل الاجتماع",
    selectForReport: "تحديد للتقرير",
    settings: "الإعدادات",
    selectFellowship: "اختيار الزمالة، الحالي: {{value}}",
    selectDay: "اختيار اليوم",
    selectLanguage: "اختيار اللغة",
    selectTime: "اختيار الوقت",
    recordArchived: "تمت أرشفة السجل",
    recordDeleted: "تم حذف السجل",
    recordSelected: "تم تحديد السجل",
    recordDeselected: "تم إلغاء تحديد السجل",
