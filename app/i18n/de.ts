...
const de: Translations = {
  ...
  errorScreen: {
    ...
    friendlySubtitle:
      "Das ist der Bildschirm, den deine Nutzer in der Produktion sehen, wenn ein Fehler auftritt.",
  ...
  loginScreen: {
    ...
    euaTitle: "Nutzungsbedingungen",
    euaAgree: "Ich stimme zu",
    euaCancel: "Abbrechen",
  },
  zoomLoginScreen: {
  ...
  onboarding: {
    ...
    noTracking: "Keine Analysen, kein Tracking, kein Google",
    totalAnonymity: "Vollständige Privatsphäre und Anonymität",
    minimalNetwork: "Der einzige Netzwerkverkehr ist für Live-Meeting-Listen",
