...
const de: Translations = {
  common: {
    ...
    storeUpdateTitle: "Neue Version verfügbar",
    storeUpdateMessage: "Eine neue Version von RecoverySky ist verfügbar. Bitte aktualisiere für die neuesten Funktionen und Fehlerbehebungen.",
    storeUpdateButton: "Jetzt aktualisieren",
  ...
  attendanceScreen: {
    ...
    exportReportDialog: "Teilnahmebericht exportieren",
    exportReportError: "Bericht konnte nicht exportiert werden. Bitte erneut versuchen.",
  ...
  settingsScreen: {
    ...
    userIdNum: "ID-Nummer",
    userIdNumPlaceholder: "(optional) Deine Berichtsnummer",
    ...
    noUpdatesAvailable: "Du bist auf dem neuesten Stand",
  ...
  topicPrompt: {
    ...
    hostPlaceholder: "Moderator des Meetings",
    save: "Speichern",
    skip: "Überspringen",
  },
  externalZoomTimer: {
  ...
  attendanceEdit: {
    ...
    save: "Speichern",
    saved: "Dauer aktualisiert",
    saveError: "Dauer konnte nicht aktualisiert werden. Bitte erneut versuchen.",
  },
  devScreen: {
