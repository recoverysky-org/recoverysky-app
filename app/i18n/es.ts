...
const es: Translations = {
  common: {
    ...
    storeUpdateTitle: "Nueva versión disponible",
    storeUpdateMessage: "Hay una nueva versión de RecoverySky disponible. Actualiza para obtener las últimas funciones y correcciones.",
    storeUpdateButton: "Actualizar ahora",
    retry: "Reintentar",
  ...
  attendanceScreen: {
    ...
    exportReportDialog: "Exportar Reporte de Asistencia",
    exportReportError: "No se pudo exportar el reporte. Inténtalo de nuevo.",
  ...
  settingsScreen: {
    ...
    userIdNumPlaceholder: "(opcional) Tu número de reporte",
    ...
    noUpdatesAvailable: "Estás al Día",
  ...
  topicPrompt: {
    ...
    hostPlaceholder: "Anfitrión de la reunión",
    save: "Guardar",
    skip: "Omitir",
  },
  externalZoomTimer: {
  ...
  attendanceEdit: {
    ...
    save: "Guardar",
    saved: "Duración actualizada",
    saveError: "No se pudo actualizar la duración. Inténtalo de nuevo.",
  },
  devScreen: {
