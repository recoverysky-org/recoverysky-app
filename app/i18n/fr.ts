...
const fr: Translations = {
  ...
  errorScreen: {
    ...
    friendlySubtitle:
      "Nous sommes désolés — quelque chose n'a pas fonctionné comme prévu. Veuillez redémarrer l'application. Si le problème persiste, contactez-nous à support@recoverysky.org.",
  ...
  homeScreen: {
    ...
    // Help Cards
    onboardingTitle: "RecoverySky, c'est la nouvelle génération d'AA/NA Live !",
    onboardingDescription:
      "Le nom a changé, mais tu verras que l'app est essentiellement la même — entièrement réécrite avec un logiciel moderne et maintenable.",
    restartOnboarding: "Recommencer l'intégration",
  ...
  attendanceScreen: {
    ...
    exportReportDialog: "Exporter le rapport de présence",
    exportReportError: "Impossible d'exporter le rapport. Veuillez réessayer.",
  ...
  settingsScreen: {
    ...
    enableMeetingTopic: "Activer le sujet de réunion",
    userIdNum: "Numéro d'identification",
    userIdNumPlaceholder: "(facultatif) Ton numéro de rapport",
    ...
    noUpdatesMessage: "Tu utilises la dernière version de RecoverySky.",
    // Advanced Section
    advancedSection: "Avancé",
    useExternalZoom: "Utiliser Zoom externe",
    useExternalZoomHint:
      "Toutes les réunions s'ouvrent dans l'application Zoom installée au lieu de l'application intégrée. Affiche des réunions supplémentaires réservées à l'app Zoom.",
    // Legal Section
    legalSection: "Légal",
  ...
  topicPrompt: {
    ...
    hint: "Quel était le sujet aujourd'hui ? Il sera enregistré avec ta présence.",
    placeholder: "Ex. Étape 4, Gratitude, Parrainage…",
    hostPlaceholder: "Animateur de la réunion",
    save: "Enregistrer",
    skip: "Passer",
  },
  externalZoomTimer: {
  ...
  attendanceEdit: {
    ...
    save: "Enregistrer",
    saved: "Durée mise à jour",
    saveError: "Impossible de mettre à jour la durée. Veuillez réessayer.",
  },
  devScreen: {
  ...
  moneySaved: {
    ...
    Sat: "Samedi",
    Sun: "Dimanche",
    tobacco: "Tabac quotidien",
    save: "Enregistrer",
    totalDays: "sur {{count}} jours de rétablissement",
  },
  recoveryChart: {
  ...
  ninetyInNinety: {
    title: "Défi 90 en 90",
    titleComplete: "90 en 90 Terminé !",
    description: "Assistez à 90 réunions en 90 jours. Un pilier du rétablissement précoce.",
    startChallenge: "Commencer le défi",
    meetingsCount: "{{count}} / 90",
    meetingsLabel: "Réunions assistées",
    totalTime: "Temps total : {{time}}",
    hoursAttended: "{{hours}} / 90 Heures assistées",
    dayProgress: "Jour {{current}} sur 90",
    daysRemaining_one: "{{count}} jour restant",
    daysRemaining_other: "{{count}} jours restants",
    strictMode: "Mode strict",
    strictDescription: "Nécessite au moins une réunion de 60 minutes chaque jour",
    strictCompliant: "{{compliant}} / {{total}} jours conformes",
    strictFailed: "Un jour a été manqué. Désactivez le mode strict pour continuer.",
    congratulations: "Félicitations !",
    challengeComplete: "Vous avez terminé le défi 90 en 90 !",
    getCertificate: "Obtenir le certificat",
    viewCertificate: "Voir le certificat",
    shareCertificate: "Partager le certificat",
    certificateReady: "Le certificat est prêt !",
    certificateError: "Impossible de générer le certificat",
    challengeExpired: "Défi terminé",
    expiredMessage: "Vous avez assisté à {{count}} réunions sur 90.",
    startNew: "Nouveau défi",
    resetTitle: "Réinitialiser le défi",
    resetMessage: "Cela effacera votre progression actuelle. Êtes-vous sûr ?",
  ...
  accessibility: {
    doubleTapToView: "Touchez deux fois pour voir les détails",
    doubleTapToJoin: "Touchez deux fois pour rejoindre la réunion",
    doubleTapToArchive: "Touchez deux fois pour archiver cet enregistrement",
    doubleTapToDelete: "Touchez deux fois pour supprimer cet enregistrement",
    doubleTapToSelect: "Touchez deux fois pour sélectionner pour le rapport",
    doubleTapToToggleFavorite: "Touchez deux fois pour basculer le favori",
    doubleTapToRate: "Touchez deux fois pour définir la note",
    doubleTapToExpand: "Touchez deux fois pour développer ou réduire",
    ...
    closeMeeting: "Fermer les détails de la réunion",
    selectForReport: "Sélectionner pour le rapport",
    settings: "Réglages",
    selectFellowship: "Sélectionner la fraternité, actuelle : {{value}}",
    selectDay: "Sélectionner le jour",
    selectLanguage: "Sélectionner la langue",
    selectTime: "Sélectionner l'heure",
    recordArchived: "Enregistrement archivé",
    recordDeleted: "Enregistrement supprimé",
    recordSelected: "Enregistrement sélectionné",
    recordDeselected: "Enregistrement désélectionné",
