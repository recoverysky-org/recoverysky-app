...
const uk: Translations = {
  ...
  externalZoomEducation: {
    ...
    body: "Коли ви приєднуєтесь до зустрічі через зовнішній Zoom, застосунок Zoom має бути встановлено. Буде запущено таймер. Ви повинні повернутися до застосунку RecoverySky після завершення зустрічі Zoom, щоб правильно зупинити таймер і отримати зарахування відвідування.",
    continue: "Продовжити",
  },
  attendanceEdit: {
