...
const ru: Translations = {
  ...
  externalZoomEducation: {
    ...
    body: "При присоединении к встрече через внешний Zoom приложение Zoom должно быть установлено. Будет запущен таймер. Вы должны вернуться в приложение RecoverySky после завершения встречи Zoom, чтобы правильно остановить таймер и получить зачёт посещения.",
    continue: "Продолжить",
  },
  attendanceEdit: {
